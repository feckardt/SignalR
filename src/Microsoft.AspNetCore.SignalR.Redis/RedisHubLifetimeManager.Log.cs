...
{
    public partial class RedisHubLifetimeManager<THub> where THub : Hub
    {
        private static class Log
        {
            ...
            public static void ConnectingToEndpoints(this ILogger logger, EndPointCollection endpoints, string serverName)
            {
